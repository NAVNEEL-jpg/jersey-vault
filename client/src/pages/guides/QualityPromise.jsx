...
export default function QualityPromise() {
  return (
    <GuideLayout
      title="Quality Promise | Jersey Vault"
      metaDescription="Our guarantee of unmatched fabric quality, precise detailing, and durable materials."
      canonicalUrl="https://www.thejerseyvault.in/pages/quality-promise"
      h1="Quality Promise"
    >
      <div className="eeat-content" style={{ fontSize: '16px', lineHeight: 1.8, color: '#ddd' }}>
        <p style={{ marginBottom: '20px' }}>
          Our guarantee of unmatched fabric quality, precise detailing, and durable materials. At Jersey Vault, we prioritize authenticity, customer satisfaction, and an undying love for the beautiful game.
        </p>
