...
export default function PrintingGuide() {
  return (
    <GuideLayout
      ...
      metaDescription="How jersey customization works: official fonts, vinyl pressing, and care instructions."
      canonicalUrl="https://www.thejerseyvault.in/pages/printingguide"
      h1="Jersey Customization & Printing Guide"
    >
      <p>Welcome to our comprehensive guide on Printing Guide. At Jersey Vault, we are dedicated to providing the ultimate football jersey experience in India.</p>
