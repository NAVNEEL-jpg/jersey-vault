...
export default function MaterialsGuide() {
  return (
    <GuideLayout
      title="Football Jersey Materials Guide"
      metaDescription="Discover the advanced fabrics used in modern football kits, from Dri-FIT to Heat.RDY."
      canonicalUrl="https://www.thejerseyvault.in/pages/materialsguide"
      h1="Football Jersey Materials & Technology"
    >
      <p>Welcome to our comprehensive guide on Football Jersey Materials Guide. At Jersey Vault, we are dedicated to providing the ultimate football jersey experience in India.</p>
