...
export default function AboutUs() {
  return (
    <GuideLayout
      title="About Us | Jersey Vault"
      metaDescription="Learn about Jersey Vault, Indias premier destination for authentic and high-quality football jerseys."
      canonicalUrl="https://www.thejerseyvault.in/pages/about-us"
      h1="About Us"
    >
      <div className="eeat-content" style={{ fontSize: '16px', lineHeight: 1.8, color: '#ddd' }}>
        <p style={{ marginBottom: '20px' }}>
          Learn about Jersey Vault, Indias premier destination for authentic and high-quality football jerseys. At Jersey Vault, we prioritize authenticity, customer satisfaction, and an undying love for the beautiful game.
        </p>
