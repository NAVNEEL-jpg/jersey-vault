...
export default function PatchGuide() {
  return (
    <GuideLayout
      title="Patch Guide"
      metaDescription="A detailed look at sleeve patches for the Premier League, Champions League, and more."
      canonicalUrl="https://www.thejerseyvault.in/pages/patchguide"
      h1="Football Jersey Patch Guide"
    >
      <p>Welcome to our comprehensive guide on Patch Guide. At Jersey Vault, we are dedicated to providing the ultimate football jersey experience in India.</p>
