...
export default function BrandStory() {
  return (
    <GuideLayout
      title="Brand Story | Jersey Vault"
      metaDescription="How Jersey Vault started from a passion for football and grew into a nationwide phenomenon."
      canonicalUrl="https://www.thejerseyvault.in/pages/brand-story"
      h1="Brand Story"
    >
      <div className="eeat-content" style={{ fontSize: '16px', lineHeight: 1.8, color: '#ddd' }}>
        <p style={{ marginBottom: '20px' }}>
          How Jersey Vault started from a passion for football and grew into a nationwide phenomenon. At Jersey Vault, we prioritize authenticity, customer satisfaction, and an undying love for the beautiful game.
        </p>
