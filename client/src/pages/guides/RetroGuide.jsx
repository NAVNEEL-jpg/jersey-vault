...
export default function RetroGuide() {
  return (
    <GuideLayout
      title="Retro Jersey Guide"
      metaDescription="Everything you need to know about collecting and wearing classic vintage football shirts."
      canonicalUrl="https://www.thejerseyvault.in/pages/retroguide"
      h1="The Retro Football Jersey Guide"
    >
      <p>Welcome to our comprehensive guide on Retro Jersey Guide. At Jersey Vault, we are dedicated to providing the ultimate football jersey experience in India.</p>
