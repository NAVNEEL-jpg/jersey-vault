...
export default function Mission() {
  return (
    <GuideLayout
      title="Mission | Jersey Vault"
      metaDescription="Our mission to bring global football culture to every fan in India."
      canonicalUrl="https://www.thejerseyvault.in/pages/mission"
      h1="Mission"
    >
      <div className="eeat-content" style={{ fontSize: '16px', lineHeight: 1.8, color: '#ddd' }}>
        <p style={{ marginBottom: '20px' }}>
          Our mission to bring global football culture to every fan in India. At Jersey Vault, we prioritize authenticity, customer satisfaction, and an undying love for the beautiful game.
        </p>
