...
export default function CustomerSupport() {
  return (
    <GuideLayout
      title="Customer Support | Jersey Vault"
      metaDescription="Get in touch with our dedicated support team for all your queries."
      canonicalUrl="https://www.thejerseyvault.in/pages/customer-support"
      h1="Customer Support"
    >
      <div className="eeat-content" style={{ fontSize: '16px', lineHeight: 1.8, color: '#ddd' }}>
        <p style={{ marginBottom: '20px' }}>
          Get in touch with our dedicated support team for all your queries. At Jersey Vault, we prioritize authenticity, customer satisfaction, and an undying love for the beautiful game.
        </p>
