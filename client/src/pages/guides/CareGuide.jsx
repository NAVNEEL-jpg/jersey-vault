...
export default function CareGuide() {
  return (
    <GuideLayout
      ...
      metaDescription="Learn how to wash, dry, and store your football kits to prevent peeling and damage."
      canonicalUrl="https://www.thejerseyvault.in/pages/careguide"
      h1="Football Jersey Care & Maintenance"
    >
      <p>Welcome to our comprehensive guide on Jersey Care Guide. At Jersey Vault, we are dedicated to providing the ultimate football jersey experience in India.</p>
