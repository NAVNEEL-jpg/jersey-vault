...
export default function SizeGuide() {
  return (
    <GuideLayout
      title="Size Guide"
      metaDescription="Find the perfect fit for your football jersey with our detailed size guide."
      canonicalUrl="https://www.thejerseyvault.in/pages/sizeguide"
      h1="Football Jersey Size Guide"
    >
      <p>Welcome to our comprehensive guide on Size Guide. At Jersey Vault, we are dedicated to providing the ultimate football jersey experience in India.</p>
