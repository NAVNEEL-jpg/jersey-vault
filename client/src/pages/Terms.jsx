...
export default function Terms() {
  return (
    <div style={{ fontFamily:"'Barlow Condensed', sans-serif", background:"#0a0a0a", minHeight:"100vh", color:"#fff" }}>
      <Helmet><title>Terms & Conditions | The Jersey Vault</title><meta name="description" content="Read the terms and conditions for The Jersey Vault." /><link rel="canonical" href="https://www.thejerseyvault.in/terms" /></Helmet>
      <style>{`
