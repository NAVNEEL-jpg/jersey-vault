      ...
      <div style={{ fontFamily: "'Barlow Condensed', sans-serif", background: "#0a0a0a", minHeight: "100vh", color: "#fff", overflowX: "hidden" }}>
        <style>{`
         ...
         .search-input::placeholder { color:#888; letter-spacing:2px; }
          ...
          .logo-img { width52px; height:54px; object-fit:contain; mix-blend-mode:screen; filter:brightness(1.2) contrast(1.1) drop-shadow(0 0 4px rgba(57,255,20,0.15)); display:block; }
...
<div className="logo-wrap" style={{ flexShrink: 0, marginLeft: 0, paddingLeft: 0 }}>
  ...
  <div className="nav-right" style={{ display: "flex", alignItems: "center", gap: 16, flexShrink: 0, marginRight: 0 }}>
    <button
