      ...
      <div style={{ fontFamily: "'Barlow Condensed', sans-serif", background: "#0a0a0a", minHeight: "100vh", color: "#fff", overflowX: "hidden" }}>
        <style>{`
         ...
         .search-input::placeholder { color:#888; letter-spacing:2px; }
          ...
          .logo-img { width:64px; height:64px; object-fit:contain; mix-blend-mode:screen; filter:brightness(1.2) contrast(1.1) drop-shadow(0 0 4px rgba(57,255,20,0.15)); display:block; }
...
@media(max-width:480px) {
  .stat-cell { padding:14px 0; }
        ...
        {/* NAVBAR */}
       <nav style={{ position: "sticky", top: 0, zIndex: 50, background: "rgba(10,10,10,0.97)", backdropFilter: "blur(10px)", borderBottom: "1px solid #1a1a1a", padding: "0 16px 0 4px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16, height: 64, animation: "slideDown 0.5s ease" }}>
  {/* LEFT: Logo */}
