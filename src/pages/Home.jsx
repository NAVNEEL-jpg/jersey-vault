      ...
      <div style={{ fontFamily: "'Barlow Condensed', sans-serif", background: "#0a0a0a", minHeight: "100vh", color: "#fff", overflowX: "hidden" }}>
        <style>{`
          ...
          * { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .search-input { background:#111; border:1px solid #222; color:#fff; padding:10px 16px; font-family:'Barlow Condensed',sans-serif; font-size:15px; outline:none; letter-spacing:1px; width:180px; }
...
@media(max-width:480px) {
  ...
  .stat-cell { padding:14px 0; }
        ...
        <nav style={{ position: "sticky", top: 0, zIndex: 50, background: "rgba(10,10,10,0.95)", backdropFilter: "blur(10px)", borderBottom: "1px solid #1a1a1a", padding: "0 16px 0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 60, animation: "slideDown 0.5s ease" }}>
          ...
          {/* FIX 1: Desktop nav — hidden on mobile */}
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            >
              🛒 {cartCount > 0 && <span style={{ background: "#39ff14", color: "#000", borderRadius: "50%", width: 18, height: 18, display: "inline-flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: 900 }}>{cartCount}</span>}
            </button>

            {/* FIX 2: Hamburger button */}
            <button
