      ...
      <div style={{ fontFamily: "'Barlow Condensed', sans-serif", background: "#0a0a0a", minHeight: "100vh", color: "#fff", overflowX: "hidden" }}>
        <style>{`
         ...
         .search-input::placeholder { color:#888; letter-spacing:2px; }
          ...
          .logo-img { width54px; height:56px; object-fit:contain; mix-blend-mode:screen; filter:brightness(1.2) contrast(1.1) drop-shadow(0 0 4px rgba(57,255,20,0.15)); display:block; }
